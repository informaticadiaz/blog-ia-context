# Comando para Agregar Contenido al Archivo failure/page.js
...
# Asegúrate de que el directorio app/failure existe
$directoryPath = "app/failure"
if (-not (Test-Path -Path $directoryPath)) {
    New-Item -ItemType Directory -Path $directoryPath -Force
}

# Crear el archivo con el contenido
$content | Out-File -FilePath "app/failure/page.js" -Encoding utf8 -NoNewline
```