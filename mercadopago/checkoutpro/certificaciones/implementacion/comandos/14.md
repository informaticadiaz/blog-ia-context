# Comando para Agregar Contenido al Archivo pending/page.js
...
if (-not (Test-Path -Path "app/pending")) {
    New-Item -ItemType Directory -Path "app/pending" -Force
}

# Escribir el contenido al archivo
$contenido | Out-File -FilePath "app/pending/page.js" -Encoding utf8
```