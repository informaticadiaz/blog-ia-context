# Comando para Agregar Contenido al Archivo Checkout.js
...
# Asegúrate de que el directorio app/components existe
$componentPath = "app/components"
if (-not (Test-Path -Path $componentPath)) {
    New-Item -ItemType Directory -Path $componentPath -Force
}

# Guardar el contenido en el archivo Checkout.js
$checkoutContent | Out-File -FilePath "$componentPath/Checkout.js" -Encoding utf8 -NoNewline
Write-Host "Archivo Checkout.js creado correctamente en $componentPath"
```