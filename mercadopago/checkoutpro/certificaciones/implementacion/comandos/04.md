# Comando para Agregar Contenido al Archivo Cart Page

```powershell
# Asegúrate de que el directorio app/cart existe
$cartPath = "app/cart"
if (-not (Test-Path -Path $cartPath)) {
    New-Item -Path $cartPath -ItemType Directory -Force
}

# Contenido del archivo page.js
$pageContent = @'
'use client';
...
# Crear el archivo page.js
Set-Content -Path "app/cart/page.js" -Value $pageContent
Write-Host "Archivo app/cart/page.js creado correctamente."
```